		...
		<div id="container_home-title">
			<div className="decor_star">
				<svg className='stars_l' width="191" height="187" viewBox="0 0 191 187" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="stars_l">
						<path id="star_bottom" d="M65.6045 167.037L83.0072 162.402L94.6566 176.136L90.0212 158.733L103.755 147.084L86.3528 151.719L74.7034 137.985L79.3388 155.388L65.6045 167.037Z" fill="#68A9C2" fill-opacity="0.36"/>
